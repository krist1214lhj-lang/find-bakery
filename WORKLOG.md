...
| (이번) | 대량수집 11라운드(제주 5동네 66곳, DB 1201행) + 숨김 재적용(65) + 일지 | ❌ (로컬, push 예정) |
...
- **대량수집 1~11라운드 승인 완료 — `bakery_locations` 1201행**(전국 17개 시·도 전부: 서울 482·경기 125·제주 96·경남 90·경북 75·전남 47·부산 46·강원 45·전북 44·충남 30·대구 30·대전 16·울산 15·인천 15·세종 15·충북 15·광주 15). 1~10R + 11R(제주 애월·협재·성산·중문·대정) 66(`--approve all --confirm`). **카테고리 미연결분은 `draft`로 숨김 → 현재 공개는 98곳(카테고리 보유)만, draft 1103.** 숨긴 곳은 카테고리 채우면 재노출 가능. ⚠️ 수집 라운드마다 저장(active) 직후 `hide-uncategorized.mjs --confirm`로 미분류 숨김 재적용 필요. 등급 미검증(D) — 원하는 곳만 정밀검증 예정.
