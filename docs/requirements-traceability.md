...
| R-003 | 부분 | 지역·빵 종류·영업·편의·검증 필터 | 탐색 필터        | BakeryLocation, SearchAlias, BreadCategory, 영업 상태 계산, VerificationRecord | Supabase 내부 검색과 카카오 키워드 후보 검색 연결; `성수동` 실제 제과·베이커리 후보 15곳 확인 |
